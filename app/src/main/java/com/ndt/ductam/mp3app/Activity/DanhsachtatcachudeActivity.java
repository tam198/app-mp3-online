...
import com.ndt.ductam.mp3app.Adapter.DanhsachtatchudeAdapter;
...
public class DanhsachtatcachudeActivity extends AppCompatActivity {
    ...
    DanhsachtatchudeAdapter danhsachtatchudeAdapter;
    ...
    private void GetData() {
        ...
        callback.enqueue(new Callback<List<ChuDe>>() {
            ...
            public void onResponse(Call<List<ChuDe>> call, Response<List<ChuDe>> response) {
                ...
                danhsachtatchudeAdapter = new DanhsachtatchudeAdapter(DanhsachtatcachudeActivity.this, mangchude);
                recyclerViewtatcachude.setLayoutManager(new GridLayoutManager(DanhsachtatcachudeActivity.this, 1));
                recyclerViewtatcachude.setAdapter(danhsachtatchudeAdapter);
            }
